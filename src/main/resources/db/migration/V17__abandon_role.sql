...
<ol>
  <li>Niniejsza polityka dotyczy Serwisu www, funkcjonującego pod adresem url: <b>vipsound.pl</b></li>
  <li>Operatorem serwisu oraz Administratorem danych osobowych jest: Patryk Wachowski</li>
  <li>Adres kontaktowy poczty elektronicznej operatora: pat.wachowski@gmail.com</li>
  <li>
...
<h2>3. Hosting</h2>
<ol>
  <li>Serwis jest hostowany (technicznie utrzymywany) na serwerach zewnętrznego operatora: Amazon Web Services (AWS). Powierzenie danych dostawcy hostingu odbywa się na podstawie odpowiednich umów zapewniających bezpieczeństwo zgodne z RODO.  </li>
