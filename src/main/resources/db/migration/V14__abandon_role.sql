...
UPDATE public.privacy_policies SET content = '
<ol>
  <li>Niniejsza polityka dotyczy Serwisu www, funkcjonującego pod adresem url: <span style="color: red;"><b>vipsound.tlm.technology</b></span></li>
  <li>Operatorem serwisu oraz Administratorem danych osobowych jest: <span style="color: red;">Patryk Wachowski</span></li>
  <li>Adres kontaktowy poczty elektronicznej operatora: <span style="color: red;">l.d.michalak@icloud.com</span></li>
  <li>
...
<h2>3. Hosting</h2>
<ol>
  <li>Serwis jest hostowany (technicznie utrzymywany) na serwerze operatora: <span style="color: red";>AWS</span></li>
  <li>
...
<ol>
  ...
  <li>
    Przysługuje Ci prawo do złożenia sprzeciwu w zakresie przetwarzania wskazanego w pkt 3.3 c) <span style="color: red";>Tego nie czaje</span> wobec
